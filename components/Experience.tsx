...
const Experience = () => {
  return (
    <div className='w-full py-20 mt-10' id='works'>
        ...
        <div className='flex lg:flex-row flex-col gap-10'>
            {workExperience.map((experience) => (
                <div key={experience.id} className='dark:bg-neutral-900 bg-neutral-200 rounded-lg lg:py-12 py-10 lg:px-10 px-8 flex-1 gap-3'>
                    <p className=''>{experience.period}</p>
                    <h1 className='text-lg font-bold'>{experience.title}</h1>
                    <div className='flex lg:flex-none flex-wrap lg:gap-3 gap-2 mb-4 lg:mb-2 pt-4'>
